(function(){
    ...
    function ProfileController(UserService,Upload,$scope,$location,AuthenticatedUser,$rootScope){
        ...
        $scope.update = function(profile){
            console.log(profile);
            UserService.UpdateProfile(id,profile.fname,profile.lname,profile.occupation,profile.website,profile.country,profile.city,profile.aboutme,profile.myhobbies,profile.facebook,profile.twitter,profile.google,profile.pinterest,profile.instagram,profile.linkedin,function(response){
                if (response.success)
                {
