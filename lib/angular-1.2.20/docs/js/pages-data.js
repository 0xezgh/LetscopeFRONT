...
angular.module('pagesData', [])
  ...
  "guide/expression": {
    ...
    "searchTerms": {
      ...
      "keywords": "$eval $event $location $parse $rootscope $window access accidental angular apart application binding bindings bugs call called clickme clutter code common complex conditional conditionals context control controller controllers core data defined delegate differences directive directives displaying docs document eval evaluate evaluated evaluating evaluation evaluations example example-example90 example-example91 example-example92 example-example93 exception exceptions expose expression expressions filters flow forgiving format function functions general generates global globals guide intentional invoking items javascript javascript-like js-angular-release language location logic loop loops method mockable ng ngclick ngdoc ngfocus note null object operator overview pass philosophy prevents processes properties provide purpose real reason referenceerror response restriction returns scope sense server service services simply snippets source statement statements subtle ternary throw throws typeerror undefined user valid variables view views waiting wasn window write"
    }
  },
  "guide/filter": {
    "docType": "overview",
  ...
  "script.js": {
    "docType": "example-js",
    "id": "example-example107/script.js",
    "outputPath": "examples/example-example107/script.js",
    "path": "script.js"
  },
  ...
  "protractor.js": {
    ...
    "id": "example-example106/protractor.js",
    "outputPath": "examples/example-example106/protractor.js",
    "path": "protractor.js"
  },
  ...
  "style.css": {
    "docType": "example-css",
    "id": "example-example104/style.css",
    "outputPath": "examples/example-example104/style.css",
    "path": "style.css"
  },
  ...
  "app.js": {
    "docType": "example-js",
    "id": "example-example76/app.js",
    "outputPath": "examples/example-example76/app.js",
    "path": "app.js"
  },
  ...
  "guide/undefined": {
    "docType": "example-manifest",
    "id": "example-example107-manifest",
    "outputPath": "examples/example-example107/manifest.json",
  ...
  "app.css": {
    "docType": "example-css",
    "id": "example-example76/app.css",
    "outputPath": "examples/example-example76/app.css",
    "path": "app.css"
  },
  ...
  "protractorTest.js": {
    "docType": "example-js",
    "id": "example-example77/protractorTest.js",
    "outputPath": "examples/example-example77/protractorTest.js",
  ...
  "my-customer.html": {
    "docType": "example-html",
    "id": "example-example81/my-customer.html",
    "outputPath": "examples/example-example81/my-customer.html",
  ...
  "my-customer-iso.html": {
    "docType": "example-html",
    "id": "example-example82/my-customer-iso.html",
    "outputPath": "examples/example-example82/my-customer-iso.html",
  ...
  "my-customer-plus-vojta.html": {
    "docType": "example-html",
    "id": "example-example83/my-customer-plus-vojta.html",
    "outputPath": "examples/example-example83/my-customer-plus-vojta.html",
  ...
  "my-dialog.html": {
    "docType": "example-html",
    "id": "example-example86/my-dialog.html",
    "outputPath": "examples/example-example86/my-dialog.html",
    "path": "my-dialog.html"
  },
  ...
  "my-dialog-close.html": {
    "docType": "example-html",
    "id": "example-example87/my-dialog-close.html",
    "outputPath": "examples/example-example87/my-dialog-close.html",
  ...
  "my-tabs.html": {
    "docType": "example-html",
    "id": "example-example89/my-tabs.html",
    "outputPath": "examples/example-example89/my-tabs.html",
    "path": "my-tabs.html"
  },
  "my-pane.html": {
    "docType": "example-html",
    "id": "example-example89/my-pane.html",
    "outputPath": "examples/example-example89/my-pane.html",
    "path": "my-pane.html"
  },
